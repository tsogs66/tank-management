...
module.exports = {
  CALC_TYPE_GAUGE_DIRECT,
  SOUNDING_GAUGE_DIRECT_M3,
  CALC_TYPE_DOUBLE_INTERP_MANUAL,
  SOUNDING_DOUBLE_INTERP_MANUAL,
  isGaugeDirectM3Tank,
  ...
  PREFERRED_INCREMENTS_MM,
  PREFERRED_INCREMENTS_M,
  alpha54B,
  vcfDetail54B,
  vcf54B,
  wcf56,
